...
I wanted library stats and last-played games on the bar without opening the Steam window.
...
Library counts and playtime are read from local Steam files by `bin/steam-library-stats`. Rebuild it after changing Go sources:
